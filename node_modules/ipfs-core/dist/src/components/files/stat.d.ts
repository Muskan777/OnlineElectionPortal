declare function _exports(context: {
    ipld: import('..').IPLD;
}): (path: string, options?: (StatOptions & import("ipfs-core-types/src/basic").AbortOptions) | undefined) => Promise<Stat>;
export = _exports;
...
export type Stat = {
     ...
     * - Modification time
     */
    mtime?: import("ipfs-core-types/src/files").MTime | undefined;
};
