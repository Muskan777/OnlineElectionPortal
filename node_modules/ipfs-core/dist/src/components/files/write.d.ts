declare function _exports(context: any): (path: string, content: string | Uint8Array | AsyncIterable<Uint8Array> | Blob, options?: (WriteOptions & import("ipfs-core-types").AbortOptions) | undefined) => Promise<void>;
export = _exports;
export type WriteOptions = {
     ...
     */
    mtime?: Date | [number, number] | import("ipfs-core-types/src/files").MTimeLike | undefined;
    /**
