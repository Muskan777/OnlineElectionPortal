declare function _exports({ repo }: {
    ...
    getAll: (options?: import("ipfs-core-types/src/basic").AbortOptions | undefined) => Promise<IPFSConfig>;
    get: (key: string, options?: import("ipfs-core-types/src/basic").AbortOptions | undefined) => Promise<import("ipfs-core-types/src/basic").ToJSON>;
    set: (key: string, value: import("ipfs-core-types/src/basic").ToJSON, options?: import("ipfs-core-types/src/basic").AbortOptions | undefined) => Promise<void>;
    replace: (value: IPFSConfig, options?: import("ipfs-core-types/src/basic").AbortOptions | undefined) => Promise<void>;
    profiles: {
 ...
 * the stored config.
 */
export type Get = (key: string, options?: import("ipfs-core-types/src/basic").AbortOptions | undefined) => Promise<ToJSON>;
/**
 * Returns the full config been used. If the daemon is off, it returns the
 * stored config.
 */
export type GetAll = (options?: import("ipfs-core-types/src/basic").AbortOptions | undefined) => Promise<IPFSConfig>;
/**
 ...
 * an effect.
 */
export type Set = (key: string, value: ToJSON, options?: import("ipfs-core-types/src/basic").AbortOptions | undefined) => Promise<void>;
/**
 ...
 */
export type Replace = (value: IPFSConfig, options?: import("ipfs-core-types/src/basic").AbortOptions | undefined) => Promise<void>;
 ...
 */
export type ListProfiles = (options?: import("ipfs-core-types/src/basic").AbortOptions | undefined) => Promise<Profile[]>;
export type Profile = {
    description: string;
    name: string;
};
 ...
 * List available config profiles
 */
export type ApplyProfile = (name: string, options?: (ApplyOptions & import("ipfs-core-types/src/basic").AbortOptions) | undefined) => Promise<{
    original: IPFSConfig;
    updated: IPFSConfig;
}>;
...
export type AddressConfig = {
    ...
    Delegates?: DelegateAddress | undefined;
    Gateway?: string | string[] | undefined;
    /**
     * *
     */
    Swarm?: SwarmAddress | undefined;
};
/**
...
export type SwarmConfig = {
    ...
    DisableNatPortMap?: boolean | undefined;
};
/**
...
export type ToJSON = string | number | boolean | import("ipfs-core-types/src/basic").ToJSON[] | ({
    toJSON?: (() => import("ipfs-core-types/src/basic").ToJSON) | undefined;
} & {
    [key: string]: import("ipfs-core-types/src/basic").ToJSON;
}) | null;
export type AbortOptions = import("ipfs-core-types/src/basic").AbortOptions;
