...
}): (block: Uint8Array | import("ipfs-core-types/src/block-service").Block, options?: (PutOptions & import("ipfs-core-types").AbortOptions) | undefined) => Promise<import("ipfs-core-types/src/block-service").Block>;
export = _exports;
...
export type IPLDBlock = import("ipfs-core-types/src/block-service").Block;
