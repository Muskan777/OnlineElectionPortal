...
declare class Service<Options_1, T> {
     ...
     * @returns {Promise<T>}
     */
    static use<T_5>({ state }: import("./service")<any, T_5>, options?: import("ipfs-core-types/src/basic").AbortOptions | undefined): Promise<T_5>;
    /**
     * @private
     ...
     */
    private constructor();
    activate: (options: Options_1) => import("ipfs-core-types/src/basic").Await<T>;
     ...
     * @returns {Promise<T>}
     */
    use(options?: import("ipfs-core-types/src/basic").AbortOptions | undefined): Promise<T>;
    /**
     * @returns {T|null}
     */
    try(): T | null;
...
type ServiceState<T> = {
    ...
    status: 'starting';
    ready: import("ipfs-core-types/src/basic").Await<T>;
} | {
    status: 'started';
    value: T;
} | {
