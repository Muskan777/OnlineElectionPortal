App = {
  ...
  render: function () {
    if (window.location.href === 'http://localhost:3000') {
        ...
        .then(function (election_count) {
          ...
          for (var i = 1; i <= election_count; i++) {
            electionInstance.elections(i).then(function (election) {
              ...
              // Render candidate ballot option
              console.log("<option value='" + id + "' >" + id + ": " + name + '</ option>')
      ...
      window.location.toString().includes('http://localhost:3000/admin_manage_election.html')
    ) {
    ...
    window.location.toString().includes('http://localhost:3000/admin_add_candidate.html')
        ...
        for(var j = 0; j <= candidate_count.toNumber(); j++) {
          // console.log(j)
            electionInstance.candidates(j).then(function (candidate) {
              console.log("Cand_id: " + candidate[0].toNumber() +  "E_id : " + candidate[3].toNumber())
      ...
      window.location.toString().includes('http://localhost:3000/Voter.html')
    ) {
      E_id = parseInt(window.location.hash.substr(-1))
    } else if (
      window.location.toString().includes('http://localhost:3000/candidate.html')
    ) {
  ...
  create_election_event: function () {
    ...
    window.location.href =
                    'http://localhost:3000/create_election.html';
  },
